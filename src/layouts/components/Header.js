                    ...
                    <Col id="logo" xs={6} ms={4} md={2} xl={5} xxl={5}>
                        <Link to="/dashboard">
                            <Col xs={24} ms={24} md={24} xl={4} xxl={4}>
                                <img src={logo} width={40} style={{paddingTop: '0.3rem'}} />
                            </Col>
                            <Col xs={0} ms={0} md={0} xl={20} xxl={20}>
                                {name}
                            </Col>
                        </Link>
                    </Col>
                    ...
                    <Col xs={8} ms={4} md={4} xl={5} xxl={5} style={{paddingTop: '0.5rem'}}>
                        <Select defaultValue={getLocale()} onChange={(v) => { this.handleChangeLanguage(v) }} className="selectLang">
                            ...
                            <Option value="en-US">
                                ...
                                <span style={{paddingLeft: '0.3rem'}}>English</span>
                            </Option>
                            <Option value="ja-JP">
                                <Icon component={japan} />
                                <span style={{paddingLeft: '0.3rem'}}>日本语</span>
                            </Option>
                        </Select>
                    </Col>
                </Row>

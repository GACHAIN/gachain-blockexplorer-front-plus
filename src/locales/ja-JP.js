export default {
	...
	COMPANYRIGHT: '政務鎖ブラウザ©2017−2019智干塗り鎖科技有限公司版権所有',
	...
	SP_NAME: 'パラメータ名',
	SP_VALUE: 'パラメーター値',
	SP_CONDITIONS: '条件を修正する',

	// Master Nodes
	MASTERNODES: 'メインノード',
	MN_TCPADDRESS: 'TCP アドレス',
	MN_TCPPORT: 'TCP ポート',
	MN_APIURL: 'API アドレス',
	MN_KEYID: 'Key ID',
	MN_PUBLICKEY: 'ノード公開鍵',
	...
	// Database
	DATABASE: 'データベース',
	DATABASEPARAMS: 'パラメータ',
	DATABASEVALUES: '値',
	DATABASE_T: '表',
	DATABASE_INFO: '基本情報',
	DATABASE_V_C: '値/フィールド',
	DATABASE_FIELDS: '・フィールド',
	DATABASE_TYPE: 'タイプ',

	// Database Description
	DATABASE_DES_ID: 'ID',
	DATABASE_DES_NAME: '名称',
	DATABASE_DES_ENGINE: 'タイプ',
	DATABASE_DES_BACKENDVERSION: 'バージョン',

	// Search
	S_T:
        '入力トランザクションのハッシュ/ブロックハッシュ/ブロックの高/口座id /アドレス。',
	S: '検索',

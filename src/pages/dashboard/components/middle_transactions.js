...
const middle_transactions = ({ data, loading }) => {
        ...
        !loading && data
            ? data.map((item, key) => {
                  return (
                      <Row
                          key={key}
                          className={styles.transactions_R}
                          style={{
                      ...
                      >
                          ...
                          <Col
                              ...
                              xl={12}
                              xxl={12}
                              className={styles.transaction_r_c_r}
                          >
                              <Row>
                                  <span>
    ...
    return (
        <Card
            className={styles.middle_transactions}
            loading={loading}
            title={
                <span>
                    <Icon
                    ...
                    />{" "}
                    <FormattedMessage id="H_TRANSACTIONS" />
                    <Link id="more" to="/transaction" replace>

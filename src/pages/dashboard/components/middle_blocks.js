...
const middle_blocks = ({ data, loading }) => {
                  ...
                  return (
                      ...
                      >
                                  ...
                                  <Row>
                                      <Col
                                          style={{
                                              ...
                                              borderRadius: "0.5rem",
                                              boxShadow:
                                                  "0.1rem 0.2rem 0.4rem 0.1rem #737373"
                                          }}
                                      >
                                          <Row>
                          ...
                          >
                              <Row>
                                  <Icon
                                      component={nodeIcon[item.node_position]}
                                      style={{
                                          fontSize: "1.5rem",
                                          marginTop: "0.8rem"
                                      }}
    ...
    return (
        <Card
            className={styles.middle_blocks}
            loading={loading}
            title={
                <span>
                    <Icon type="block" style={{ fontSize: "20px" }} />{" "}
                    <FormattedMessage id="H_BLOCKS" />
                    <Link id="more" to="/block" replace>
                        <FormattedMessage id="MORE" />
                    </Link>
                </span>
            }
            bodyStyle={{ height: "30rem", overflow: "scroll" }}
        >
            {compontents}
        </Card>
    );
